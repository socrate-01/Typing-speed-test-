...
if __name__ == '__main__':
    prompt = ["Hi, my name is Socrate, Welcome to the renaissance", "Do you wanna be great at typing","How to learn programming langage for begineers"]
    prompt = random.choice(prompt)
    print("The rule is simple, type the sentence below : ")
